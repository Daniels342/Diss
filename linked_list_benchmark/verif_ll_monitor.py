...
symbol_address = b.sym("optimised_delete", args.binary)
absolute_address = symbol_address + OFFSET  # OFFSET is your custom offset
b.attach_uprobe(name=args.binary, addr=absolute_address, fn_name="probe_delete_state")
